            ...
            <div className='brands-container'>
                <div className='card'>
                    <Link to='https://www.nike.com'>
                        <img src={Nike} alt='nike logo' className='card2' style={{ width: 100, height: 100 }} />
                    </Link>
                </div>
                <div className='card'>
                    <Link to='https://www.adidas.com/us'>
                        <img src={Addidas} alt='addidas logo' className='card2' style={{ width: 130, height: 100 }} />
                    </Link>
                </div>
                <div className='card'>
                    <Link to='https://www.gucci.com/us/en/'>
                        <img src={Gucci} alt='gucci logo' className='card2' style={{ width: 140, height: 100 }} />
                    </Link>
                </div>
                <div className='card'>
                    <Link to='https://www.prada.com/us/en.html'>
                        <img src={Prada} alt='prada logo' className='card2' style={{ width: 130, height: 100 }} />
                    </Link>
                </div>
                <div className='card'>
                    <Link to='https://us.supreme.com'>
                        <img src={Supreme} alt='supreme logo' className='card2' style={{ width: 270, height: 100 }} />
                    </Link>
                </div>
            </div>
        </>
