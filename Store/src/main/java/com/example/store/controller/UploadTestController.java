...
;
import com.example.store.FileUtils;
        ...
        for (MultipartFile file : files) {    //循环保存文件
            ...
            if (file.getSize() / 1000 > 100){
                ...
                if (fileType.equals("image/jpeg") || fileType.equals("image/png") || fileType.equals("image/jpeg")) {
                    // 要上传的目标文件存放的绝对路径
//                    final String localPath="C:\\Users\\chao\\Documents\\classes\\static\\img";
                    final String localPath= System.getProperty("user.dir")+"\\src\\main\\resources\\static\\images";
